    ...
    <_main>
      ...
      <_inner>
        <div className="_terms">
          <strong className="terms_big">제 1 장 총칙</strong>
          <strong className="terms_tit">제 1 조 (목적)</strong>
          <p className="terms_txt">
            본 약관은 (주)빅토 미술로생각하기가 운영하는 웹 사이트
            (http://misulo.com/)의 제반 서비스의 이용조건 및 절차에 관한 사항 및
            기타 필요한 사항을 규정함을 목적으로 한다.
          </p>
          <br />
          <br />
          <strong className="terms_tit">제 2 조 (용어의 정의)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_tit">제 4 조 (약관 외 준칙)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_big">제 2 장 이용계약</strong>
          <strong className="terms_tit">제 5 조 (이용신청)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_tit">제 6 조 (이용신청의 승낙)</strong>
          <p className="terms_txt">
            ...
            승낙을 유보할 수 있다.
            <br />
            <em className="terms_gap"></em>가. 서비스 관련 설비에 여유가 없는
            경우
            <br />
            <em className="terms_gap"></em>나. 기술상 지장이 있는 경우
            <br />
            <em className="terms_gap"></em>다. 기타 회사 사정상 필요하다고
            인정되는 경우
            <br />
            ③ 회사는 아래 사항에 해당하는 경우에 승낙을 하지 않을 수 있다.
            <br />
            <em className="terms_gap"></em>가. 다른 사람의 명의를 사용하여
            신청한 경우
            <br />
            <em className="terms_gap"></em>나. 이용자 정보를 허위로 기재하여
            신청한 경우
            <br />
            <em className="terms_gap"></em>다. 사회의 안녕질서 또는 미풍양속을
            저해할 목적으로 신청한 경우
            <br />
            <em className="terms_gap"></em>라. 기타 회사가 정한 이용신청 요건이
            미비한 경우
          </p>
          <br />
          <br />
          <br />
          <strong className="terms_big">제 3 장 계약 당사자의 의무</strong>
          <strong className="terms_tit">제 7 조 (회사의 의무)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_tit">제 8 조 (이용자의 의무)</strong>
          <p className="terms_txt">
            ...
            영리행위도 할 수 없다.
            <br />③ 이용자는 본 사이트를 통해 얻는 정보를 회사의 사전 승낙 없이
          ...
          <br />
          <br />
          <strong className="terms_big">제 4 장 서비스의 제공 및 이용</strong>
          <strong className="terms_tit">제 9 조 (서비스 이용)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_tit">제 10 조 (정보의 제공)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_tit">제 11 조 (광고게재)</strong>
          <p className="terms_txt">
            ① 회사는 서비스의 운용과 관련하여 서비스 화면, 홈페이지, 전자우편
            등에 광고 등을 게재할 수 있다.
            <br />② 회사는 사이트에 게재되어 있는 광고주의 판촉활동에 회원이
            참여하거나 교신 또는 거래의 결과로서 발생하는 모든 손실 또는 손해에
            대해 책임을 지지 않는다.
          </p>
          <br />
          <br />
          <strong className="terms_tit">제 12 조 (서비스 이용의 제한)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_tit">제 13 조 (서비스 제공의 중지)</strong>
          <p className="terms_txt">
            ...
            제공이 어려운 경우
            <br />⑤ 전시, 사변, 천재지변 또는 이에 준하는 국가비상사태가
            발생하거나 발생할 우려가 있는 경우
          </p>
          <br />
          <br />
          <strong className="terms_tit">제 14 조 (게시물 관리)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_tit">제 15 조 (서비스 이용 책임)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_big">
            제 5 장 (재화의 주문 및 결제 관련){' '}
          </strong>
          <strong className="terms_tit">제16조 (결제방법)</strong>
          <p className="terms_txt">
            ...
            수 있고 ‘회사’는 배송전에 이용자의 요청이 있는 경우에는 지체 없이 그
            요청에 따라 처리한다. 다만 이미 대금을 지불한 경우에는 제18조의
            ‘반품규정’을 따른다.
          </p>
          <br />
          <br />
          <strong className="terms_tit">제17조 (배송정책)</strong>
          <p className="terms_txt">
          ...
          <br />
          <br />
          <strong className="terms_tit">18조 (취소 및 반품 환불 규정)</strong>
          <p className="terms_txt">
            ...
            <br />② 재화가 발송 된 이후 결제 취소는 불가하다. 단, ‘회사’의
            부주의 ‘배송’상의 문제로 인한 재화의 파손, 변질의 경우 ‘회사’는
            이용자에게 구매 금액의 반품 및 환불 조취 및 교환 조취를 취한다.
          </p>
          <br />
          <br />
          <strong className="terms_big">제 6 장 기타</strong>
          <strong className="terms_tit">제 19 조 (면책 및 손해배상)</strong>
          <p className="terms_txt">
            ...
            <br />⑥ 이용자가 본 약관의 규정을 위반함으로써 회사에 손해가
            발생하는 경우 이 약관을 위반한 이용자는 회사에 발생한 모든 손해를
            배상해야 하며 동 손해로부터 회사를 면책시켜야 한다.
          </p>
          <br />
          <br />
          <strong className="terms_tit">
          ...
          <br />
          <br />
          <strong className="terms_tit">제 21 조 (분쟁의 해결)</strong>
          <p className="terms_txt">
            ① 회사와 이용자는 본 사이트 이용과 관련해 발생한 분쟁을 원만하게
            해결하기 위하여 필요한 모든 노력을 해야 한다.
            <br />② 제1항의 규정에도 불구하고 동 분쟁으로 인하여 소송이 제기될
            경우 동 소송은 회사의 본사 소재지를 관할하는 법원의 관할로 본다.
          </p>
          <br />
          <br />
          &lt;부칙&gt;
          <br />
          <p className="terms_txt">본 약관은 2015년 07월 1일부터 적용한다.</p>
        </div>
      </_inner>
    </_main>
  );
